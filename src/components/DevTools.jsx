...
/**
 * DevTools — Sélecteur d'interface (outil de développement).
 *
 * Widget flottant permettant de basculer rapidement entre les 3 interfaces
 * (Admin / Gestionnaire / Agent) sans passer par un écran de connexion.
 * À retirer / désactiver en production.
 */
      ...
      {isOpen && (
        <div className="w-72 rounded-xl border bg-card shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <div className="p-3 space-y-1.5">
            <p className="px-1 pb-1 text-[11px] text-foreground/50">
              Basculer vers une interface :
            </p>
            {ROLE_LIST.map((role) => {
          ...
          <div className="border-t px-4 py-2.5 bg-surface/40">
            <p className="text-[10px] text-foreground/50">
              Outil de développement — à désactiver en production.
            </p>
          </div>
        </div>
      )}
